    ...
    >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-sm font-semibold text-blue-900">{expertName}</div>
            <div className="text-xs text-blue-700">Available for consultation</div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-3">
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              <p className="text-sm text-red-800 font-medium">Failed to load availability</p>
        ...
        <>
          {dates.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-xs text-gray-400 mt-1">Try checking back later</p>
            </div>
          ) : (
            <div className="space-y-4 max-h-[320px] overflow-y-auto pr-2">
              {dates.map((date) => (
                <div key={date} className="space-y-2">
                  <div className="text-xs font-semibold text-gray-700 bg-gray-50 px-2 py-1 rounded border border-gray-200">
