#!/usr/bin/env python3
"""
Test script for PRD generation endpoints.
Tests the three critical PRD endpoints:
...
class PRDEndpointTester:
    ...
    async def run_all_tests(self):
        ...
        all_passed = all([health_ok, session_ok, prd_ok, preview_ok, download_ok])
